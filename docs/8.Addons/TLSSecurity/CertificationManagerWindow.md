...
11. <p id="root_11">**# Column**: </p>
12. <p id="root_12">**User Column**: </p>
13. <p id="root_13">**Lock Column**: </p>
14. <p id="root_14">**Subject Column**: </p>
15. <p id="root_15">**Issuer Column**: </p>
...
11. <p id="intermediate_11">**# Column**: </p>
12. <p id="intermediate_12">**User Column**: </p>
13. <p id="intermediate_13">**Lock Column**: </p>
14. <p id="intermediate_14">**Subject Column**: </p>
15. <p id="intermediate_15">**Issuer Column**: </p>
...
A client certificate can be associated with a domain. If the server asks for a client certificate during the TLS handshake, the client going to send it.
...
4. <p id="client_4">**# Column**: </p>
5. <p id="client_5">**Target Domain Column**: </p>
6. <p id="client_6">**Authority Column**: </p>
7. <p id="client_7">**Certifications**: </p>
8. <p id="client_8">**Certificate Size Stats**: </p>
...
<div class="circles" >
	...
	<a href="#request_2"><div class="circle-with-text" style="top:-40%;left:97%">2</div></a>
</div>
